define(function(require,exports,module){
	exports.scroll=function(id1,di2){
		...
		function scroll(m){
		  if(m<=oUp.offsetTop+oUp.offsetHeight){
		      m=oUp.offsetTop+oUp.offsetHeight;
		  };
		  if(m>=oBox.offsetHeight-oDown.offsetHeight-oRoll.offsetHeight){
		      m=oBox.offsetHeight-oDown.offsetHeight-oRoll.offsetHeight;
		  }
		  var scrla=m/(oBox.offsetHeight-oDown.offsetHeight-oRoll.offsetHeight);
